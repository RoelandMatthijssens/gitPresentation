...
\section{Internals}
	...
	\input{./slides/gitObjectHashmap.tex}

	\subsection{Git Objects}
	\input{./slides/gitObjects.tex}

	\subsection{branches are not objects, what is head}
	\input{./slides/branches.tex}

	\subsection{tags}
	\input{./slides/tags.tex}
...
\section{Gitflow}
	\input{./slides/gitflow.tex}

	\subsection{Scenarios}
	\input{./slides/scenarios.tex}

	\subsection{demo}
	\input{./slides/demo.tex}

	\subsection{previous encountered issues}
	\input{./slides/mergeVsRebase.tex}
